  ...
  SENT_CLIENT_REQUEST: {
    ...
    events: {
      ...
      message: function (message) {
        ...
        if ((_this$request = this.request) !== null && _this$request !== void 0 && _this$request.canceled) {
          this.tokenStreamParser.once('endOfMessage', () => {
          ...
          if (this.request instanceof _request.default && this.request.paused) {
            ...
            // resume the request if it was paused so we can read the remaining tokens
            (_this$request2 = this.request) === null || _this$request2 === void 0 ? void 0 : _this$request2.resume();
          }
        } else {
          var _this$request5;
          ...
          const onCancel = () => {
            ...
            if (this.request instanceof _request.default && this.request.paused) {
              ...
              // resume the request if it was paused so we can read the remaining tokens
              (_this$request3 = this.request) === null || _this$request3 === void 0 ? void 0 : _this$request3.resume();
            }
          };
          ...
          const onEndOfMessage = () => {
            ...
            (_this$request4 = this.request) === null || _this$request4 === void 0 ? void 0 : _this$request4.removeListener('cancel', onCancel);
            this.transitionTo(this.STATE.LOGGED_IN);
            const sqlRequest = this.request;
            this.request = undefined;
          ...
          (_this$request5 = this.request) === null || _this$request5 === void 0 ? void 0 : _this$request5.once('cancel', onCancel);
        }
      }
    }
  },
